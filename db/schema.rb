...
ActiveRecord::Schema.define(version: 20140326164944) do
  ...
  create_table "do_not_plays", force: true do |t|
    t.integer  "user_id"
    t.integer  "chain_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "do_not_plays", ["chain_id"], name: "index_do_not_plays_on_chain_id", using: :btree
  add_index "do_not_plays", ["user_id"], name: "index_do_not_plays_on_user_id", using: :btree
